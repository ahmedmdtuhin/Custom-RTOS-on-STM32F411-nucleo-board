...
Src/%.o Src/%.su Src/%.cyclo: ../Src/%.c Src/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DSTM32F411xE -c -I../Inc -I"E:/TUK_Summer2023/Sep 08_2023/Real Time OS on STM32 and TIVA C/MyOwnRTOS/STM32CubeIDE/2_timebase/chip_headers/CMSIS/Include" -I"E:/TUK_Summer2023/Sep 08_2023/Real Time OS on STM32 and TIVA C/MyOwnRTOS/STM32CubeIDE/2_timebase/chip_headers/CMSIS/Device/ST/STM32F4xx/Include" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -fcyclomatic-complexity -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@"
